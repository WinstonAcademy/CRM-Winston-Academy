...
Winston Academy CRM Team`,
        ...
        console.log('📋 Reset token generated:', resetPasswordToken);
        console.log('🔗 Reset URL:', `${resetPasswordUrl}?code=${resetPasswordToken}`);
        console.log('⚠️ Email sending failed, but reset token was generated. Check SMTP configuration.');
        // Continue - return success even if email fails
      }
